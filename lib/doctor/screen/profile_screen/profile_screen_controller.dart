...
import 'package:doclink/doctor/screen/setting_screen/setting_screen.dart';
...
class ProfileScreenController extends GetxController {
  ...
  void reviewApiCall() {
    ...
    DoctorApiService.instance.fetchDoctorReviews(start: start).then((value) {
      if (start == 0) {
