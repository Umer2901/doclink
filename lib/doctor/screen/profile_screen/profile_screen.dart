...
import 'package:doclink/doctor/screen/profile_screen/profile_screen_controller.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/award_page.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/detail_page.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/education_page.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/experience_page.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/list_of_category.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/profile_top_bar_card.dart';
import 'package:doclink/doctor/screen/profile_screen/widget/review_page.dart';
          ...
          CustomScrollView(
            ...
            slivers: [
              GetBuilder(
                init: controller,
                builder: (controller) {
                  print('${ConstRes.itemBaseURL}${controller.doctorData?.image}');
                                    ...
                                    Opacity(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              '${controller.doctorData?.rating!.toStringAsFixed(1) ?? 0}',
                                              style: const TextStyle(
                                                  color: ColorRes.mangoOrange,
                                                  fontSize: 18,
