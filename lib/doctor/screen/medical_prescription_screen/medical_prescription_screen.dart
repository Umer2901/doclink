...
import 'package:doclink/doctor/screen/medical_prescription_screen/medical_prescription_screen_controller.dart';
...
class MedicalPrescriptionScreen extends StatelessWidget {
  bool? isVideoCall;
  MedicalPrescriptionScreen({Key? key, this.isVideoCall}) : super(key: key);
  SignatureController _controller = SignatureController();
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(MedicalPrescriptionScreenController(isvideoCall: isVideoCall));
    return Scaffold(
      backgroundColor: ColorRes.white,
      body: Column(
        children: [
          TopBarArea(title: S.current.medicalPrescription, isVideoCall: true,),
          Expanded(
      ...
      child: Text(
        "Add Signature",
        style: TextStyle(fontSize: 15, color: ColorRes.charcoalGrey, fontFamily: FontRes.semiBold),
      ),
    ),
    const SizedBox(
                    height: 10,
    ...
    Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            "Clear",
            style: TextStyle(fontSize: 12, color: Colors.white, fontFamily: FontRes.medium),
          ),
        ),
      ),
    )
