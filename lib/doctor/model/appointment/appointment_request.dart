...
class AppointmentData {
  AppointmentData({
    ...
    _rating = rating;
    _patient_symptoms = patient_symptoms;
  }
  ...
  AppointmentData.fromJson(dynamic json) {
    ...
    _patient_symptoms = json['patient_symptoms'] == null ? null : jsonDecode(json['patient_symptoms']);
  }
  ...
  Rating? _rating;
  List<dynamic>? _patient_symptoms;
  ...
  List<dynamic>? get patient_symptoms => _patient_symptoms;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['patient_symptoms'] = jsonEncode(_patient_symptoms);
