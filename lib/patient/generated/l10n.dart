...
class PS {
  ...
  static PS get current {
    assert(_current != null,
        'No instance of S was loaded. Try to initialize the S delegate before accessing PS.current.');
    return _current!;
  }

  static const AppLocalizationDelegate delegate = AppLocalizationDelegate();

  static Future<PS> load(Locale locale) {
  ...
  static PS of(BuildContext context) {
    final instance = PS.maybeOf(context);
    assert(instance != null,
        'No instance of S present in the widget tree. Did you add PPS.delegate in localizationsDelegates?');
    return instance!;
  }

  static PS? maybeOf(BuildContext context) {
  ...
  String get continueasPatientText {
    return Intl.message(
      'Continue as Patient',
      name: 'continueasPatientText',
      desc: '',
      args: [],
    );
  }
...
class AppLocalizationDelegate extends LocalizationsDelegate<PS> {
  ...
  @override
  Future<PS> load(Locale locale) => PS.load(locale);
