...
class RegistrationData {
  RegistrationData({
    ...
    Map<String,dynamic>? medical_hsitory
  }) {
    _id = id;
    _isBlock = isBlock;
    _identity = identity;
  ...
  RegistrationData.fromJson(dynamic json) {
    ...
    _medical_history = json['medical_history'] == null ?  json['medical_history'] : jsonDecode(json['medical_history']);
  ...
  Map<String,dynamic>? _medical_history;
  ...
  Map<String,dynamic>? get medical_history => _medical_history;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['medical_history'] = jsonEncode(_medical_history);
    if (_patients != null) {
