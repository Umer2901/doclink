...
class FetchAppointment {
  ...
  FetchAppointment.fromJson(dynamic json) {
    _status = json['status'];
...
class AppointmentData {
  ...
  AppointmentData.fromJson(dynamic json) {
    ...
    _payableAmount = json['payable_amount'].toDouble();
    ...
    if (json['previous_appointments'] != null) {
      ...
      json['previous_appointments'].forEach((v) {
        _previousAppointments?.add(PreviousAppointments.fromJson(v));
      });
    }
    _user =
  ...
  String? _createdAt;
  String? _updatedAt;
  List<PreviousAppointments>? _previousAppointments;
  ...
  List<PreviousAppointments>? get previousAppointments => _previousAppointments;
