...
import 'package:doclink/patient/screen/doctor_profile_screen/widget/languages.dart';
import 'package:doclink/patient/screen/doctor_profile_screen/widget/service_location.dart';
            ...
            child: Container(
              ...
              child: InkWell(
                ...
                child: Text(
                  !showMore
                      ? PS.current.less
                      : "+${(services?.length ?? 0) - 4} ${PS.current.more}",
