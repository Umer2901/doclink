...
import 'package:doclink/patient/screen/recharge_wallet_sheet/recharge_wallet_sheet_controller.dart';
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      screenType == 1
                          ? PS.current.rechargeWallet
                          : PS.current.insufficientBalance,
                      style: MyTextStyle.montserratExtraBold(
                          size: 20, color: ColorRes.charcoalGrey),
                    ),
                    Text(
                      screenType == 1
                          ? PS.current.addMoneyToYourWallet
                          : PS.current.thereIsNotEnoughEtc,
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: PS.current.enterAmountOfYourChoice,
