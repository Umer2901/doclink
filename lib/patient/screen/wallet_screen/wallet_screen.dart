...
import 'package:doclink/patient/screen/wallet_screen/wallet_screen_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          TopBarArea(title: PS.current.wallet),
          Card(
            elevation: 3,
          ...
          builder: (context) {
            return controller.isLoading
                ...
                : controller.walletData == null ||
                    ...
                    ? CustomUi.noData(title: PS.current.noDataAvailable)
                    : ListView.builder(
