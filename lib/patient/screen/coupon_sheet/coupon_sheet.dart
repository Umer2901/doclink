...
import 'package:doclink/patient/screen/coupon_sheet/coupon_sheet_controller.dart';
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${PS.current.max} $dollar${coupons?.maxDiscountAmount.toString() ?? ''}'
                                                .toUpperCase(),
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: MyTextStyle.montserratLight(
