...
import 'package:doclink/patient/screen/prescription_screen/prescription_screen_controller.dart';
...
class PrescriptionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          TopBarArea(title: PS.current.prescriptions),
          const SizedBox(
            height: 10,
          ),
          Expanded(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          data?.appointment?.doctor?.name ??
                                              '${PS.current.dr} ${PS.current.unKnown}',
