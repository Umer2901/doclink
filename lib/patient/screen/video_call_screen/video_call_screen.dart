...
import 'package:doclink/patient/screen/video_call_screen/video_call_screen_controller.dart';
import 'package:doclink/patient/screen/video_call_screen/widget/bottom_buttom_area.dart';
import 'package:doclink/patient/screen/video_call_screen/widget/top_bar_name_card.dart';
import 'package:doclink/patient/screen/video_call_screen/widget/video_call_placeholder.dart';
                ...
                SizedBox(
                  ...
                  child: controller.remoteUserId != null
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                controller.type == 1
                                    ? BlurTextCard(
                                        name:
                                            '${appointmentChat.senderUser?.name ?? ''} Left the meeting')
                                    : !controller.isRemoteMutedAudio
                                        ? const SizedBox()
                                        : BlurTextCard(
                                            name:
                                                '${appointmentChat.senderUser?.name ?? ''} Mute the Audio'),
                              ],
                            )
                          ],
                        )
                      ...
                      : RemotePlaceHolder(
                          ...
                          widget: BlurTextCard(
                            name:
                                'Waiting for ${appointmentChat.senderUser?.name ?? ''}',
                          ),
                        ),
                ),
                SafeArea(
                          ...
                          child: controller.isJoined
                              ...
                              ? ClipRRect(
                                  ...
                                  child: controller.isVideo
                                      ...
                                      : LocalPlaceHolder(
                                          image:
                                              '${appointmentChat.videoCall?.patientImage}',
                                          name: appointmentChat
                                                  .videoCall?.patientName?[0] ??
                                              ''),
                                )
